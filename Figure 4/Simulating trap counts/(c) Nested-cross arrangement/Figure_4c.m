...
%No. of traps
J = 24; 
%b = x1* in Eqn (19) in the manuscript. The first trap along the horizontal-right wing is placed with coordinates (b, 0).
b = 4;
%Minimum separation factor
wmin = (2.*r0)./b + 1;
%Maximum separation factor
wmax = ((R-r0)./b).^(4./(J-4));
%Normalised separation factor
k = 0; %Varied between 0 and 1
w = wmin + k.*(wmax - wmin);                                                                 
