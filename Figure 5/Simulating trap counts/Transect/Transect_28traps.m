...
x9 = d.*(9./2)./sqrt(2); y9 = d.*(9./2)./sqrt(2); 
x10 = -d.*(9./2)./sqrt(2); y10 = -d.*(9./2)./sqrt(2);
x11 = d.*(11./2)./sqrt(2); y11 = d.*(11./2)./sqrt(2); 
x12 = -d.*(11./2)./sqrt(2); y12 = -d.*(11./2)./sqrt(2);

x13 = d.*(13./2)./sqrt(2); y13 = d.*(13./2)./sqrt(2); 
x14 = -d.*(13./2)./sqrt(2); y14 = -d.*(13./2)./sqrt(2);
x15 = d.*(15./2)./sqrt(2); y15 = d.*(15./2)./sqrt(2); 
x16 = -d.*(15./2)./sqrt(2); y16 = -d.*(15./2)./sqrt(2);

x17 = d.*(17./2)./sqrt(2); y17 = d.*(17./2)./sqrt(2); 
x18 = -d.*(17./2)./sqrt(2); y18 = -d.*(17./2)./sqrt(2);
x19 = d.*(19./2)./sqrt(2); y19 = d.*(19./2)./sqrt(2); 
x20 = -d.*(19./2)./sqrt(2); y20 = -d.*(19./2)./sqrt(2);

x21 = d.*(21./2)./sqrt(2); y21 = d.*(21./2)./sqrt(2); 
x22 = -d.*(21./2)./sqrt(2); y22 = -d.*(21./2)./sqrt(2);
x23 = d.*(23./2)./sqrt(2); y23 = d.*(23./2)./sqrt(2); 
x24 = -d.*(23./2)./sqrt(2); y24 = -d.*(23./2)./sqrt(2);

x25 = d.*(25./2)./sqrt(2); y25 = d.*(25./2)./sqrt(2); 
x26 = -d.*(25./2)./sqrt(2); y26 = -d.*(25./2)./sqrt(2);
x27 = d.*(27./2)./sqrt(2); y27 = d.*(27./2)./sqrt(2); 
x28 = -d.*(27./2)./sqrt(2); y28 = -d.*(27./2)./sqrt(2);
...
Ncount = 0;
for k = 1:N;
if r1(k,1) < r0 | r2(k,1) < r0 |r3(k,1) < r0 | r4(k,1) < r0 | r5(k,1) < r0| r6(k,1) < r0 | r7(k,1) < r0 | r8(k,1) < r0 | r9(k,1) < r0 | r10(k,1) < r0 | r11(k,1) < r0 | r12(k,1) < r0 |r13(k,1) < r0 | r14(k,1) < r0 | r15(k,1) < r0 | r16(k,1) < r0|r17(k,1) < r0 | r18(k,1) < r0 | r19(k,1) < r0 | r20(k,1) < r0|r21(k,1) < r0 | r22(k,1) < r0 | r23(k,1) < r0 | r24(k,1) < r0 | r25(k,1) < r0 | r26(k,1) < r0 | r27(k,1) < r0 | r28(k,1) < r0;
        Ncount = Ncount + 1;
...
if    r1(k,a) < r0 | r2(k,a) < r0 |r3(k,a) < r0 | r4(k,a) < r0 | r5(k,a) < r0| r6(k,a) < r0 | r7(k,a) < r0 | r8(k,a) < r0 |r9(k,a) < r0| r10(k,a) < r0 | r11(k,a) < r0 | r12(k,a) < r0|r13(k,a) < r0| r14(k,a) < r0 | r15(k,a) < r0 | r16(k,a) < r0|r17(k,a) < r0| r18(k,a) < r0 | r19(k,a) < r0 | r20(k,a) < r0|r21(k,a) < r0| r22(k,a) < r0 | r23(k,a) < r0 | r24(k,a) < r0| r25(k,a) < r0| r26(k,a) < r0| r27(k,a) < r0| r28(k,a) < r0;
      Ntrap = Ntrap + 1;
      Jtrap(a) = Ntrap;                
...
plot(xunit25, yunit25,'g',xunit26, yunit26,'g',xunit27, yunit27,'g',xunit28, yunit28,'g','linewidth',1.5); 
