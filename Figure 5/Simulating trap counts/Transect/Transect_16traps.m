...
Ncount = 0;
for k = 1:N;
    if (r1(k,1) < r0|r2(k,1) < r0|r3(k,1) < r0|r4(k,1)<r0|r5(k,1)<r0|r6(k,1)<r0|r7(k,1)<r0|r8(k,1)<r0|r9(k,1) < r0 | r10(k,1) < r0 | r11(k,1) < r0 | r12(k,1)<r0|r13(k,1) < r0 | r14(k,1) < r0 | r15(k,1) < r0 | r16(k,1)<r0)
        Ncount = Ncount + 1;
...
for a = 2:p;
    for k = 1:N;
        ...
        if    (r1(k,a) < r0|r2(k,a) < r0|r3(k,a) < r0|r4(k,a)<r0|r5(k,a)<r0|r6(k,a)<r0|r7(k,a)<r0|r8(k,a)<r0|r9(k,a) < r0 | r10(k,a) < r0 | r11(k,a) < r0 | r12(k,a)<r0|r13(k,a) < r0 | r14(k,a) < r0 | r15(k,a) < r0 | r16(k,a)<r0)
            Ntrap = Ntrap + 1;
            Jtrap(a) = Ntrap;
...
plot(xunit1, yunit1,'r',xunit2, yunit2,'r',xunit3,yunit3,'r',xunit4,yunit4,'r',xunit5, yunit5,'r',xunit6, yunit6,'r',xunit7,yunit7,'r',xunit8,yunit8,'r',xunit9, yunit9,'r',xunit10, yunit10,'r',xunit11,yunit11,'r',xunit12,yunit12,'r',xunit13, yunit13,'r',xunit14, yunit14,'r',xunit15,yunit15,'r',xunit16,yunit16,'r','linewidth',1.5);
